...
insert  into `com_property_addresses`(`id`,`address_type`,`address`,`door_no`,`building_name`,`pin`,`area`,`street`,`land_mark`,`district`,`city_id`,`state_id`,`country_id`,`status`,`location`,`google_link`,`latitude`,`longitude`,`created_at`,`updated_at`,`deleted_at`) values 
(1,NULL,NULL,NULL,NULL,'622 515',NULL,NULL,NULL,NULL,1,1,NULL,NULL,NULL,NULL,NULL,NULL,'2023-08-31 11:18:01','2023-08-31 11:18:01',NULL),
(2,NULL,NULL,'Rebecca Nichols','Aubrey Meyer','Noel Holt','Aliquam omnis ducimu','Daria Stephens','Eaque minima volupta',NULL,1,1,NULL,NULL,NULL,NULL,NULL,NULL,'2023-08-31 11:27:49','2023-08-31 11:27:49',NULL);
...
/*Table structure for table `hrm_resource_activities` */

DROP TABLE IF EXISTS `hrm_resource_activities`;
...
/*Data for the table `hrm_resource_activities` */

insert  into `hrm_resource_activities`(`id`,`name`,`active_status_id`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'DateOfjoining',1,NULL,NULL,NULL),
(2,'Rejoin',1,NULL,NULL,NULL),
(3,'Break',2,NULL,NULL,NULL),
(4,'Relived',3,NULL,NULL,NULL);

/*Table structure for table `hrm_resource_activity_statuses` */

DROP TABLE IF EXISTS `hrm_resource_activity_statuses`;
...
/*Data for the table `hrm_resource_activity_statuses` */

insert  into `hrm_resource_activity_statuses`(`id`,`name`,`active_status`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'Working',0,NULL,NULL,NULL),
(2,'AdmitBreak',1,NULL,NULL,NULL),
(3,'Relive Resource',1,NULL,NULL,NULL),
(4,'suspension',1,NULL,NULL,NULL),
(5,'terminated',1,NULL,NULL,NULL);
...
(1,'2023_04_06_085136_create_temp_mobiles_table',1),
(2,'2023_04_06_090826_create_temp_mobiles_table',2),
(3,'2023_04_06_151202_create_temp_emails_table',3),
(5,'2022_08_27_100404_create_temp_organizations_table',4);
...
CREATE TABLE `organization_addresses` (
  ...
  `address_cachet` int(11) DEFAULT NULL,
...
/*Table structure for table `organization_administrators` */

DROP TABLE IF EXISTS `organization_administrators`;

CREATE TABLE `organization_administrators` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `org_id` int(11) NOT NULL,
  `uid` text NOT NULL,
  `administrator_type_id` int(11) DEFAULT NULL,
  `administrator_verification` int(11) DEFAULT NULL,
  `status` int(11) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
/*Data for the table `organization_administrators` */
...
/*Data for the table `organization_categories` */
...
insert  into `organization_databases`(`id`,`org_id`,`db_name`,`created_at`,`updated_at`,`deleted_at`) values 
(1,1,'1693480680propelsoft','2023-08-31 11:18:01','2023-08-31 11:18:01',NULL),
(2,2,'1693481268GravesandPotterAssociates','2023-08-31 11:27:48','2023-08-31 11:27:48',NULL);
...
insert  into `organization_details`(`id`,`org_id`,`title_id`,`org_name`,`org_alias`,`started_date`,`year_of_establishment`,`is_registered_org`,`date_of_reg`,`created_at`,`updated_at`) values 
(1,1,NULL,'propel soft',NULL,NULL,NULL,NULL,NULL,'2023-08-31 11:18:01','2023-08-31 11:18:01'),
(2,2,NULL,'Graves and Potter Associates',NULL,NULL,NULL,NULL,NULL,'2023-08-31 11:27:48','2023-08-31 11:27:48');
...
CREATE TABLE `organization_documents` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `org_id` int(11) NOT NULL,
  `org_gst_no` varchar(255) DEFAULT NULL,
  `org_pan_no` varchar(255) DEFAULT NULL,
...
/*Data for the table `organization_documents` */

insert  into `organization_documents`(`id`,`org_id`,`org_gst_no`,`org_pan_no`,`doc_validity`,`attachment`,`status`,`created_at`,`updated_at`,`deleted_at`) values 
(1,1,'45565','12345',NULL,NULL,1,'2023-08-31 11:18:01','2023-08-31 11:18:01',NULL),
(2,2,'Massey Maldonado Associates','Bartlett Mcintosh Inc',NULL,NULL,1,'2023-08-31 11:27:49','2023-08-31 11:27:49',NULL);
...
insert  into `organization_emails`(`id`,`org_id`,`email`,`email_verification`,`status`,`created_at`,`updated_at`) values 
(1,1,'soft@gmail.com',NULL,1,'2023-08-31 11:18:01','2023-08-31 11:18:01'),
(2,2,'bizytyla@mailinator.com',NULL,1,'2023-08-31 11:27:48','2023-08-31 11:27:48');

/*Table structure for table `organization_mobiles` */

DROP TABLE IF EXISTS `organization_mobiles`;

CREATE TABLE `organization_mobiles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `org_id` int(11) NOT NULL,
  `country_id` int(11) DEFAULT NULL,
  `mobile_no` varchar(255) NOT NULL,
  `mobile_cachet` int(11) DEFAULT NULL,
  `mobile_updated_on` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `mobile_validation` int(11) DEFAULT NULL,
  `validation_updated_on` int(11) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `organization_mobiles` */

/*Table structure for table `organization_ownerships` */

DROP TABLE IF EXISTS `organization_ownerships`;

CREATE TABLE `organization_ownerships` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `org_id` int(11) NOT NULL,
  `org_ownership_id` int(11) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `organization_ownerships` */

/*Table structure for table `organization_phones` */

DROP TABLE IF EXISTS `organization_phones`;
...
/*Data for the table `organization_phones` */
...
insert  into `organization_web_addresses`(`id`,`org_id`,`web_address`,`status`,`created_at`,`updated_at`,`deleted_at`) values 
(1,1,NULL,1,'2023-08-31 11:18:01','2023-08-31 11:18:01',NULL),
(2,2,'Love Robinson Trading',1,'2023-08-31 11:27:49','2023-08-31 11:27:49',NULL);
...
insert  into `organizations`(`id`,`stage`,`origin`,`existence`,`authorization`,`reason`,`created_at`,`updated_at`) values 
(1,'1',1,NULL,1,NULL,'2023-08-31 11:18:01','2023-08-31 11:18:01'),
(2,'2',1,NULL,1,NULL,'2023-08-31 11:27:48','2023-08-31 11:27:48');
...
CREATE TABLE `person_addresses` (
  ...
  `uid` text NOT NULL,
  `property_address_id` int(11) NOT NULL,
  `address_cachet` int(11) NOT NULL,
...
insert  into `person_addresses`(`id`,`uid`,`property_address_id`,`address_cachet`,`address_updated_on`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'7eec10cf-6e7e-4587-8ac7-efea6e4950f7',2,1,'2023-08-24 10:04:30','2023-08-24 04:34:30','2023-08-24 04:34:30',NULL);
...
insert  into `person_anniversarys`(`id`,`uid`,`occasions_id`,`anniversary_date`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'a068df2b-8d90-4097-8184-c9b4dc62e548',NULL,'2000-08-18','2023-08-22 09:46:34','2023-08-22 09:46:34',NULL),
(2,'7eec10cf-6e7e-4587-8ac7-efea6e4950f7',NULL,'2000-08-18','2023-08-24 04:34:29','2023-08-24 04:34:29',NULL),
(3,'1440036b-3a8e-4321-be95-252071299db8',NULL,'2000-08-18','2023-08-24 09:35:09','2023-08-24 09:35:09',NULL);
...
insert  into `person_details`(`id`,`uid`,`salutation_id`,`first_name`,`middle_name`,`last_name`,`nick_name`,`dob`,`birth_place`,`gender_id`,`blood_group_id`,`marital_id`,`nationality_id`,`survial`,`decesaed_date`,`comments`,`created_at`,`updated_at`) values 
(1,'28c5621e-3d9c-45dc-b44c-9d473d2d1af0',14,'harish S','kumar','S','kutty','2000-08-18','',9,11,NULL,NULL,NULL,NULL,NULL,'2023-08-18 10:54:37','2023-08-24 06:40:14'),
(2,'9569cf1b-df49-4f01-a096-c344a354e952',14,'rahul','prasadth','ragu','R','2000-08-18','',9,11,NULL,NULL,NULL,NULL,NULL,'2023-08-21 04:18:39','2023-08-21 04:18:39'),
(3,'cbc70f8e-6e04-4a9e-b4cc-9d3b25deb714',14,'Sakthi','vel','sak','R','2000-08-18','',9,11,NULL,NULL,NULL,NULL,NULL,'2023-08-21 04:45:52','2023-08-21 04:45:52'),
(5,'c4dfe62c-1564-4e61-862a-98b165d71d9a',14,'dinesh','kumar','dinu','A','2000-08-18','',9,11,NULL,NULL,NULL,NULL,NULL,'2023-08-22 04:43:50','2023-08-22 04:43:50'),
(6,'a068df2b-8d90-4097-8184-c9b4dc62e548',14,'Hilda','Alana Barrera','Mcconnell','Gabriel Erickson','2000-08-18','Omnis sed odio volup',10,15,14,NULL,NULL,NULL,NULL,'2023-08-22 09:46:34','2023-08-22 09:46:34'),
(7,'7eec10cf-6e7e-4587-8ac7-efea6e4950f7',15,'Brenda','Felix Padilla','Finley','Dustin Cole','2000-08-18','Sit Nam tempor dicta',10,11,14,NULL,NULL,NULL,NULL,'2023-08-24 04:34:30','2023-08-24 04:34:30'),
(8,'1440036b-3a8e-4321-be95-252071299db8',14,'mani','kumar','maran','manu','2000-08-18','trichy',9,11,14,NULL,NULL,NULL,NULL,'2023-08-24 09:35:09','2023-08-24 09:35:09');
...
CREATE TABLE `person_documents` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` text NOT NULL,
  `person_doc_types` int(11) DEFAULT NULL,
...
insert  into `person_documents`(`id`,`uid`,`person_doc_types`,`Doc_no`,`doc_validity`,`attachment`,`status`,`created_at`,`updated_at`) values 
(1,'7eec10cf-6e7e-4587-8ac7-efea6e4950f7',2,'123','123',NULL,1,'2023-08-24 04:34:30','2023-08-24 04:34:30');
...
CREATE TABLE `person_educations` (
  ...
  `qualification` varchar(750) DEFAULT NULL,
  `education_place` varchar(150) DEFAULT NULL,
  `year_of_pass` year(4) DEFAULT NULL,
...
insert  into `person_educations`(`id`,`uid`,`qualification`,`education_place`,`year_of_pass`,`mark`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'7eec10cf-6e7e-4587-8ac7-efea6e4950f7','B.Tech','BDU',2018,'A','2023-08-24 04:34:30','2023-08-24 04:34:30',NULL);
...
CREATE TABLE `person_emails` (
  ...
  `uid` text NOT NULL,
  `email` varchar(255) NOT NULL,
  `email_cachet` int(11) NOT NULL,
  `email_updated_on` datetime DEFAULT current_timestamp(),
  `otp_received` int(11) DEFAULT NULL,
  `email_validation_status` int(11) DEFAULT NULL,
  `email_validation_updated_on` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  KEY `id` (`id`)
...
insert  into `person_emails`(`id`,`uid`,`email`,`email_cachet`,`email_updated_on`,`otp_received`,`email_validation_status`,`email_validation_updated_on`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'28c5621e-3d9c-45dc-b44c-9d473d2d1af0','harish@gmail.com',1,NULL,65249,1,'2023-08-25 06:25:22','2023-08-18 10:54:37','2023-08-25 06:25:22',NULL),
(2,'9569cf1b-df49-4f01-a096-c344a354e952','rahul@gmail.com',1,'2023-08-21 09:48:39',8802,1,'2023-08-24 04:37:29','2023-08-21 04:18:39','2023-08-24 04:37:29',NULL),
(3,'cbc70f8e-6e04-4a9e-b4cc-9d3b25deb714','sakthi@gmail.com',1,'2023-08-21 10:15:52',81532,1,'2023-08-21 10:40:46','2023-08-21 04:45:52','2023-08-21 10:40:46',NULL),
(5,'c4dfe62c-1564-4e61-862a-98b165d71d9a','dinesh@gmail.com',1,'2023-08-22 10:13:50',25974,1,'2023-08-25 08:55:08','2023-08-22 04:43:50','2023-08-25 08:55:08',NULL),
(6,'a068df2b-8d90-4097-8184-c9b4dc62e548','ravi@gmail.com',1,'2023-08-22 15:16:34',NULL,NULL,'2023-08-22 15:16:34','2023-08-22 09:46:34','2023-08-22 09:46:34',NULL),
(7,'7eec10cf-6e7e-4587-8ac7-efea6e4950f7','demo@gmail.com',1,'2023-08-24 10:04:30',NULL,NULL,'2023-08-24 10:04:30','2023-08-24 04:34:30','2023-08-24 04:34:30',NULL),
(8,'7eec10cf-6e7e-4587-8ac7-efea6e4950f7','gudebufyzu@mailinator.com',2,'2023-08-24 10:04:30',NULL,NULL,'2023-08-24 10:04:30','2023-08-24 04:34:30','2023-08-24 04:34:30',NULL),
(9,'1440036b-3a8e-4321-be95-252071299db8','well@gmail.com',1,'2023-08-24 15:05:09',NULL,NULL,'2023-08-24 15:05:09','2023-08-24 09:35:09','2023-08-24 09:35:09',NULL);
...
insert  into `person_languages`(`id`,`uid`,`language_id`,`mother_tongue`,`read`,`write`,`spoken`,`status`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'a068df2b-8d90-4097-8184-c9b4dc62e548',2,'Tamil',NULL,NULL,NULL,1,'2023-08-22 09:46:34','2023-08-22 09:46:34',NULL),
(2,'7eec10cf-6e7e-4587-8ac7-efea6e4950f7',7,'demo New',NULL,NULL,NULL,1,'2023-08-24 04:34:30','2023-08-24 04:34:30',NULL),
(3,'1440036b-3a8e-4321-be95-252071299db8',1,'English',NULL,NULL,NULL,1,'2023-08-24 09:35:09','2023-08-24 09:35:09',NULL);
...
insert  into `person_mobiles`(`id`,`uid`,`country_id`,`mobile_no`,`mobile_cachet`,`mobileno_updated_on`,`otp_received`,`mobile_validation`,`validation_updated_on`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'28c5621e-3d9c-45dc-b44c-9d473d2d1af0',NULL,'8838721805',1,'2023-08-24 15:05:47',8522,NULL,'2023-08-18 16:24:37','2023-08-18 10:54:37','2023-08-24 09:35:47',NULL),
(2,'9569cf1b-df49-4f01-a096-c344a354e952',NULL,'9698591808',1,'2023-08-24 10:06:42',9495,NULL,'2023-08-21 09:48:39','2023-08-21 04:18:39','2023-08-24 04:36:42',NULL),
(3,'cbc70f8e-6e04-4a9e-b4cc-9d3b25deb714',NULL,'9865395029',1,'2023-08-21 16:11:27',6411,NULL,'2023-08-21 10:15:52','2023-08-21 04:45:52','2023-08-21 10:41:27',NULL),
(5,'c4dfe62c-1564-4e61-862a-98b165d71d9a',NULL,'9865396190',1,'2023-08-25 14:24:30',6952,NULL,'2023-08-22 10:13:50','2023-08-22 04:43:50','2023-08-25 08:54:30',NULL),
(6,'a068df2b-8d90-4097-8184-c9b4dc62e548',NULL,'9874563211',1,'2023-08-22 16:48:38',3061,NULL,'2023-08-22 15:16:34','2023-08-22 09:46:34','2023-08-22 11:18:38',NULL),
(7,'7eec10cf-6e7e-4587-8ac7-efea6e4950f7',NULL,'9865741230',1,'2023-08-24 10:04:30',NULL,NULL,'2023-08-24 10:04:30','2023-08-24 04:34:30','2023-08-24 04:34:30',NULL),
(8,'7eec10cf-6e7e-4587-8ac7-efea6e4950f7',NULL,'8787890678',2,'2023-08-24 10:04:30',NULL,NULL,'2023-08-24 10:04:30','2023-08-24 04:34:30','2023-08-24 04:34:30',NULL),
(9,'1440036b-3a8e-4321-be95-252071299db8',NULL,'9087897678',1,'2023-08-24 15:05:09',NULL,NULL,'2023-08-24 15:05:09','2023-08-24 09:35:09','2023-08-24 09:35:09',NULL);
...
CREATE TABLE `person_professions` (
  ...
  `organization` varchar(450) DEFAULT NULL,
...
insert  into `person_professions`(`id`,`uid`,`designation`,`department`,`organization`,`doj`,`dor`,`experience`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'7eec10cf-6e7e-4587-8ac7-efea6e4950f7','STudent','CS','PS',NULL,NULL,'2023-08-05','2023-08-24 04:34:30','2023-08-24 04:34:30',NULL);
...
CREATE TABLE `person_profile_pics` (
  ...
  `profile_cachet` int(11) NOT NULL,
...
insert  into `person_profile_pics`(`id`,`uid`,`profile_pic`,`status`,`profile_cachet`,`profile_updated_on`,`created_at`,`updated_at`,`deleted_at`) values 
(5,'28c5621e-3d9c-45dc-b44c-9d473d2d1af0','20230824085712_64e71b688fd2a.jpg',1,1,'2023-08-24 14:27:12','2023-08-24 08:57:12','2023-08-24 08:57:12',NULL);
...
insert  into `person_web_addresses`(`id`,`uid`,`web_add`,`web_cachet`,`status`,`created_at`,`updated_at`,`deleted_at`) values 
(3,'7eec10cf-6e7e-4587-8ac7-efea6e4950f7','https://www.dasyqeb.mobi',1,1,'2023-08-24 04:34:30','2023-08-24 04:34:30',NULL);
...
insert  into `persons`(`id`,`uid`,`stage`,`origin`,`existence`,`reason`,`updated_at`,`created_at`) values 
(1,'28c5621e-3d9c-45dc-b44c-9d473d2d1af0',1,1,1,NULL,'2023-08-18 10:54:37','2023-08-18 10:54:37'),
(2,'9569cf1b-df49-4f01-a096-c344a354e952',1,1,1,NULL,'2023-08-21 04:18:39','2023-08-21 04:18:39'),
(3,'cbc70f8e-6e04-4a9e-b4cc-9d3b25deb714',1,1,1,NULL,'2023-08-21 04:45:52','2023-08-21 04:45:52'),
(5,'c4dfe62c-1564-4e61-862a-98b165d71d9a',1,1,1,NULL,'2023-08-22 04:43:50','2023-08-22 04:43:50'),
(6,'a068df2b-8d90-4097-8184-c9b4dc62e548',1,1,1,NULL,'2023-08-22 09:46:34','2023-08-22 09:46:34'),
(7,'7eec10cf-6e7e-4587-8ac7-efea6e4950f7',1,1,1,NULL,'2023-08-24 04:34:29','2023-08-24 04:34:29'),
(8,'1440036b-3a8e-4321-be95-252071299db8',1,1,1,NULL,'2023-08-24 09:35:09','2023-08-24 09:35:09');
...
insert  into `pims_banks`(`id`,`bank`,`ifsc`,`micr`,`created_at`,`updated_at`,`deleted_at`,`active_status`) values 
(1,'SBI','757567','32423','2023-07-21 10:47:04','2023-07-21 10:48:11',NULL,0),
(2,'ICICI','757567','32423','2023-07-21 10:48:29','2023-07-21 10:49:37','2023-07-21 10:49:37',0),
(3,'IOB','132','123','2023-07-27 06:18:48','2023-07-27 06:18:48',NULL,1),
(4,'IOB','132','123','2023-07-27 06:19:02','2023-07-27 06:19:02',NULL,1),
(5,'fast','123','123','2023-07-27 06:19:25','2023-07-27 06:32:07','2023-07-27 06:32:07',0),
(6,'www','www','www','2023-07-27 06:19:36','2023-07-27 06:31:41','2023-07-27 06:31:41',1),
(7,'1','1','1','2023-07-27 06:32:38','2023-07-27 06:32:55','2023-07-27 06:32:55',1);
...
insert  into `pims_com_address_types`(`id`,`address_of`,`active_status`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'Home',NULL,NULL,NULL,NULL),
(2,'Office',NULL,NULL,NULL,NULL),
(3,'bank',NULL,NULL,NULL,NULL),
(4,'Warehouse',NULL,NULL,NULL,NULL),
(5,'Godown',NULL,NULL,'2023-08-05 06:19:29','2023-08-05 06:19:29'),
(6,'Shop',NULL,NULL,'2023-08-04 07:33:54','2023-08-04 07:33:54'),
(7,'Factory',0,'2023-07-21 11:34:52','2023-07-21 11:36:45','2023-07-21 11:36:45'),
(8,'Native',0,'2023-07-21 11:35:43','2023-07-21 11:36:40','2023-07-21 11:36:40'),
(9,'demo',1,'2023-07-27 06:44:24','2023-07-27 06:56:27','2023-07-27 06:56:27'),
(10,'testing',0,'2023-07-27 06:44:38','2023-07-27 06:55:59','2023-07-27 06:55:59'),
(11,'part New',1,'2023-07-27 06:44:52','2023-07-27 06:55:47','2023-07-27 06:55:47');
...
insert  into `pims_com_cities`(`id`,`name`,`state_id`,`active_status`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'Salem',1,1,'2023-07-25 09:25:10','2023-07-28 06:47:35',NULL),
(2,'erode',2,1,'2023-07-25 09:25:28','2023-07-25 09:27:04',NULL),
(3,'trichy',1,1,'2023-07-25 09:25:40','2023-07-25 09:25:40',NULL),
(5,'Chennai',1,1,'2023-07-28 06:28:47','2023-07-28 06:28:47',NULL),
(6,'madurai',1,0,'2023-07-28 06:29:08','2023-07-28 06:29:08',NULL),
(7,'vellore new',10,1,'2023-07-28 06:29:31','2023-07-28 06:47:04','2023-07-28 06:47:04'),
(8,'orisa',2,0,'2023-07-28 06:48:03','2023-07-28 06:50:08','2023-07-28 06:50:08');
...
insert  into `pims_com_countries`(`id`,`name`,`active_status`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'london',1,'2023-07-25 07:03:21','2023-07-28 07:26:26','2023-07-28 07:26:26'),
(2,'UK',1,'2023-07-25 07:05:27','2023-07-25 07:05:38',NULL),
(3,'Indian',1,'2023-07-26 10:00:12','2023-07-26 10:23:48',NULL),
(4,'USA',1,'2023-07-26 10:00:26','2023-07-26 10:00:26',NULL),
(5,'Sri Lanka',1,'2023-07-26 10:25:48','2023-07-26 10:27:15',NULL),
(6,'Pakistan New',0,'2023-07-26 10:25:59','2023-07-26 10:26:55','2023-07-28 11:36:20');
...
insert  into `pims_com_languages`(`id`,`name`,`active_status`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'English',0,NULL,NULL,NULL),
(2,'Tamil',0,NULL,NULL,NULL),
(3,'Hindi',0,NULL,NULL,NULL),
(4,'Telngu',0,NULL,NULL,NULL),
(5,'Malayalam',0,NULL,NULL,NULL),
(6,'Kannada',0,NULL,NULL,NULL),
(7,'malayalam',1,'2023-07-22 06:14:35','2023-07-22 06:17:08','2023-07-22 06:17:08'),
(8,'new',1,'2023-07-27 07:15:31','2023-07-27 07:15:31',NULL),
(9,'new',0,'2023-07-27 07:15:46','2023-07-27 07:15:46',NULL),
(10,'demo New',1,'2023-07-27 07:15:56','2023-07-27 07:25:47','2023-07-27 07:25:47'),
(11,'part',0,'2023-07-27 07:26:02','2023-07-27 07:26:26','2023-07-27 07:26:26');
...
insert  into `pims_com_states`(`id`,`name`,`country_id`,`active_status`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'Tamil Nadu',3,1,'2023-07-25 07:24:33','2023-07-28 07:34:26',NULL),
(2,'Delhi',2,1,'2023-07-25 07:24:54','2023-07-25 09:05:37',NULL),
(3,'Gujarat',3,1,'2023-07-25 07:25:54','2023-07-28 07:37:38',NULL),
(6,'TN',3,1,'2023-07-28 05:32:53','2023-07-28 05:32:53',NULL),
(7,'TN',3,1,'2023-07-28 05:33:28','2023-07-28 05:33:28',NULL),
(8,'delhi',3,0,'2023-07-28 05:33:47','2023-07-28 06:09:34',NULL),
(9,'Class New',4,1,'2023-07-28 05:35:14','2023-07-28 06:07:47',NULL),
(10,'dd',2,1,'2023-07-28 05:35:46','2023-07-28 07:36:32',NULL),
(11,'Aus New',2,1,'2023-07-28 06:10:43','2023-07-28 07:29:46',NULL);
...
insert  into `pims_org_administrator_types`(`id`,`org_administrator_type`,`active_status`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'Owner',NULL,NULL,NULL,NULL),
(2,'Partner',NULL,NULL,NULL,NULL),
(3,'Manging Director',NULL,NULL,NULL,NULL),
(4,'Director',NULL,NULL,NULL,NULL),
(5,'Employer',NULL,NULL,NULL,NULL),
(6,'Employee',NULL,NULL,NULL,NULL),
(7,'Auditor',NULL,NULL,NULL,NULL),
(8,'sample1',1,'2023-07-22 07:20:33','2023-07-22 07:22:42','2023-07-22 07:22:42'),
(9,'sample145656554',1,'2023-07-22 07:23:06','2023-07-22 07:23:33','2023-07-22 07:23:33'),
(10,'test',0,'2023-07-27 10:44:53','2023-07-27 10:44:53',NULL),
(11,'demo',1,'2023-07-27 10:45:20','2023-07-27 10:52:23','2023-07-27 10:52:23'),
(12,'color new',0,'2023-07-27 10:45:34','2023-07-27 10:52:08','2023-07-27 10:52:08');
...
insert  into `pims_org_business_activities`(`id`,`business_activity`,`active_status`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'Sales',1,NULL,'2023-07-27 10:07:26',NULL),
(2,'Service',NULL,NULL,NULL,NULL),
(3,'Manufacturing',NULL,NULL,NULL,NULL),
(4,'Production',NULL,NULL,NULL,NULL),
(5,'Export',NULL,NULL,NULL,NULL),
(6,'Testing',0,'2023-07-22 09:49:42','2023-07-22 09:51:14','2023-07-22 09:51:14'),
(7,'Testing',0,'2023-07-22 09:52:06','2023-07-22 09:52:06',NULL),
(8,'demo',0,'2023-07-27 10:00:11','2023-07-27 10:00:11',NULL),
(9,'clear New',1,'2023-07-27 10:00:31','2023-07-27 10:08:48','2023-07-27 10:08:48'),
(10,'Part',0,'2023-07-27 10:09:10','2023-07-27 10:09:10',NULL),
(11,'slowbgdg',0,'2023-07-27 10:09:18','2023-07-27 10:09:42','2023-07-27 10:09:42');
...
insert  into `pims_org_business_sale_subsets`(`id`,`business_sale_subset`,`active_status`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'Retail',NULL,NULL,NULL,NULL),
(2,'Whole Sale',NULL,NULL,NULL,NULL),
(3,'Trading',NULL,NULL,NULL,NULL),
(4,'E-commerce',NULL,NULL,NULL,NULL),
(5,'new one',0,'2023-07-22 10:17:36','2023-07-22 10:18:48','2023-07-22 10:18:48'),
(6,'common new',1,'2023-07-27 11:42:20','2023-07-27 11:51:26','2023-07-27 11:51:26'),
(7,'fast',0,'2023-07-27 11:42:37','2023-07-27 11:42:37',NULL),
(8,'new',0,'2023-07-27 11:52:05','2023-07-27 11:52:22','2023-07-27 11:52:22');
...
insert  into `pims_org_business_sectors`(`id`,`business_sector`,`active_status`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'Sector',0,'2023-07-24 11:52:05','2023-07-24 11:52:31',NULL),
(2,'Sector New',0,'2023-07-24 11:52:39','2023-07-24 11:53:41','2023-07-24 11:53:41'),
(3,'new',1,'2023-07-27 12:00:10','2023-07-27 12:00:10',NULL),
(4,'yes',1,'2023-07-27 12:00:18','2023-07-27 12:07:24','2023-07-27 12:07:24'),
(5,'demo',0,'2023-07-27 12:00:46','2023-07-27 12:07:40','2023-07-27 12:07:40');
...
insert  into `pims_org_categories`(`id`,`org_category`,`active_status`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'Business',NULL,NULL,NULL,NULL),
(2,'Goverment',NULL,NULL,NULL,NULL),
(3,'NGO-Non Gov Org',NULL,NULL,NULL,NULL),
(4,'Social Party',NULL,NULL,NULL,NULL),
(5,'Society',NULL,NULL,NULL,NULL),
(7,'demo testing',1,'2023-07-24 12:37:04','2023-07-24 12:38:50','2023-07-24 12:38:50'),
(8,'last',1,'2023-07-27 12:17:32','2023-07-27 12:24:53','2023-07-27 12:24:53'),
(9,'clodse',0,'2023-07-27 12:18:26','2023-07-27 12:18:26',NULL),
(10,'growth',1,'2023-07-27 12:25:07','2023-07-27 12:25:23','2023-07-27 12:25:23');
...
insert  into `pims_org_document_types`(`id`,`org_doc_type`,`active_status`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'PAN',NULL,NULL,NULL,NULL),
(2,'GST',NULL,NULL,NULL,NULL),
(3,'CIN',NULL,NULL,NULL,NULL),
(4,'TAN',NULL,NULL,NULL,NULL),
(5,'TIN',NULL,NULL,NULL,NULL),
(6,'SME',NULL,NULL,NULL,NULL),
(7,'FSSAI',NULL,NULL,NULL,NULL),
(8,'Partner_registration',NULL,NULL,NULL,NULL),
(9,'Registration Of Factories',NULL,NULL,NULL,NULL),
(10,'Udyog aadhar',NULL,NULL,NULL,NULL),
(11,'demo',1,'2023-07-25 04:39:40','2023-07-25 04:42:59','2023-07-25 04:42:59'),
(12,'2',1,'2023-07-27 12:36:39','2023-07-27 12:43:36','2023-07-27 12:43:36'),
(13,'wwww',0,'2023-07-27 12:37:22','2023-07-27 12:43:50','2023-07-27 12:43:50');
...
insert  into `pims_org_ownerships`(`id`,`org_ownership`,`active_status`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'Professional',NULL,NULL,NULL,NULL),
(2,'Sole Proprietorship',NULL,NULL,NULL,NULL),
(3,'Partnership',NULL,NULL,NULL,NULL),
(4,'LIC',NULL,NULL,NULL,NULL),
(5,'Pvt Limited',NULL,NULL,NULL,NULL),
(6,'Public Limited',0,NULL,NULL,NULL),
(7,'Trust/Foundation',NULL,NULL,NULL,NULL),
(8,'demo',1,'2023-07-25 05:28:20','2023-07-25 05:29:15','2023-07-25 05:29:15'),
(9,'new',1,'2023-07-27 12:52:30','2023-07-27 12:58:37','2023-07-27 12:58:37'),
(10,'newb',0,'2023-07-27 12:52:39','2023-07-27 12:59:04','2023-07-27 12:59:04'),
(11,'demo  2',0,'2023-07-27 12:52:49','2023-07-27 12:58:24','2023-07-27 12:58:24');

/*Table structure for table `pims_permissions` */

DROP TABLE IF EXISTS `pims_permissions`;
...
/*Data for the table `pims_permissions` */

insert  into `pims_permissions`(`id`,`name`,`active_status`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'setting',1,NULL,NULL,NULL),
(2,'CommonMaster',1,NULL,NULL,NULL),
(3,'Organization',1,NULL,NULL,NULL);
...
insert  into `pims_person_blood_groups`(`id`,`blood_group`,`created_at`,`updated_at`,`description`,`active_status`,`deleted_at`) values 
(11,'A+ve','2023-07-18 12:17:55','2023-07-18 12:28:09','sample',1,'2023-07-18 12:28:09'),
(12,'AB','2023-07-26 11:28:31','2023-07-26 11:28:31','demo',1,NULL),
(13,'AB','2023-07-26 11:28:47','2023-07-26 11:28:47','demo',1,NULL),
(14,'AC','2023-07-26 11:29:00','2023-07-26 11:29:00',NULL,0,NULL),
(15,'requried','2023-07-26 11:29:54','2023-07-26 11:58:42','ssss',1,'2023-07-26 11:58:42'),
(16,'New','2023-07-26 12:00:23','2023-07-26 12:00:55','New',1,NULL),
(17,'Part','2023-07-26 12:00:39','2023-07-26 12:01:32','clear',1,NULL);
...
insert  into `pims_person_document_types`(`id`,`person_doc_type`,`active_status`,`created_at`,`updated_at`,`deleted_at`) values 
(1,'Aadhar',1,NULL,NULL,NULL),
(2,'PAN New',1,NULL,'2023-07-26 09:10:06','2023-07-26 09:10:06'),
(3,'Driving license',1,NULL,'2023-07-26 09:07:33',NULL),
(4,'DIN',1,NULL,NULL,NULL),
(5,'Passport',0,NULL,NULL,NULL),
(6,'Voter ID',0,NULL,NULL,NULL),
(7,'new',1,'2023-07-25 05:56:24','2023-07-25 05:57:45','2023-07-25 05:57:45'),
(8,'demo',1,'2023-07-25 05:56:38','2023-07-25 05:57:36','2023-07-25 05:57:36'),
(9,'pan new',1,'2023-07-26 09:15:43','2023-07-26 09:16:29',NULL),
(10,'color',0,'2023-07-26 09:15:52','2023-07-26 09:16:06',NULL);
...
insert  into `pims_person_genders`(`id`,`gender`,`active_status`,`created_at`,`updated_at`,`deleted_at`,`description`) values 
(9,'male',1,'2023-07-18 07:11:53','2023-07-18 07:11:53',NULL,NULL),
(10,'female',1,'2023-07-20 11:27:32','2023-07-20 11:28:06',NULL,NULL);
...
insert  into `pims_person_marital_statues`(`id`,`name`,`created_at`,`updated_at`,`description`,`active_status`,`deleted_at`) values 
(14,'Single','2023-07-26 12:37:29','2023-07-26 12:38:28',NULL,0,'2023-07-26 12:38:28');
...
insert  into `pims_person_relationships`(`id`,`person_relationship`,`created_at`,`updated_at`,`deleted_at`,`description`,`active_status`) values 
(14,'Father','2023-07-19 05:39:45','2023-07-19 05:39:45',NULL,NULL,0),
(15,'Sons','2023-07-19 05:40:15','2023-07-19 05:41:48','2023-07-19 05:41:48',NULL,0),
(16,'new One','2023-07-27 04:03:32','2023-07-27 04:23:21','2023-07-27 04:23:21',NULL,0),
(17,'test','2023-07-27 04:03:45','2023-07-27 04:03:45',NULL,NULL,0),
(18,'like','2023-07-27 04:03:54','2023-07-27 04:03:54',NULL,NULL,1),
(19,'fast','2023-07-27 04:23:40','2023-07-27 04:24:15',NULL,'fast',1),
(20,'slow','2023-07-27 04:23:58','2023-07-27 04:24:45','2023-07-27 04:24:45',NULL,0);
...
insert  into `pims_person_salutations`(`id`,`salutation`,`active_status`,`created_at`,`updated_at`,`deleted_at`,`description`) values 
(14,'mr',0,'2023-07-18 07:08:42','2023-07-18 07:11:08',NULL,'sample'),
(15,'ms',1,'2023-07-20 11:18:42','2023-07-20 11:18:42',NULL,NULL),
(16,'other',1,'2023-07-20 11:25:43','2023-07-20 11:25:43',NULL,NULL),
(17,'men',1,'2023-07-20 11:26:28','2023-07-20 11:26:28',NULL,NULL);

/*Table structure for table `pims_role_masters` */

DROP TABLE IF EXISTS `pims_role_masters`;

CREATE TABLE `pims_role_masters` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `as_admin` int(11) DEFAULT NULL,
  `active_status` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
/*Data for the table `pims_role_masters` */

insert  into `pims_role_masters`(`id`,`name`,`as_admin`,`active_status`,`created_at`,`updated_at`,`deleted_at`) values 
(5,'Master Person',9,0,'2023-08-04 07:25:51','2023-08-04 07:32:37',NULL),
(6,'Setting New',9,0,'2023-08-04 07:33:03','2023-08-04 07:34:05',NULL),
(8,'Clear',9,0,'2023-08-05 06:29:10','2023-08-05 06:31:50','2023-08-05 06:31:50'),
(9,'Clear',9,0,'2023-08-05 06:35:56','2023-08-05 06:37:06','2023-08-05 06:37:06'),
(10,'Clear',9,0,'2023-08-05 06:36:52','2023-08-05 06:37:14','2023-08-05 06:37:14');

/*Table structure for table `pims_roles` */

DROP TABLE IF EXISTS `pims_roles`;
...
insert  into `pims_users`(`id`,`name`,`mobile`,`email`,`password`,`role_id`,`active_status`,`created_at`,`updated_at`,`deleted_at`) values 
(5,'harish Kumar','9698591808','kumar@gmail.com','$2y$10$inZMEV9eEo0Ij4DNTIoDneck4Nhm1UggZt2CIJYmBhyaE0fUiRVa2',6,NULL,'2023-07-21 06:44:45','2023-08-05 11:48:56',NULL),
(6,'dinesh','9865395029','dinesh@gmail.com','$2y$10$yelHkCorZ1BGHOpCC/f96.Jzs9cgB3G8lqvpk2B90oOSX8bxjeJLO',4,NULL,'2023-08-05 03:57:30','2023-08-05 09:40:10',NULL),
(7,'Ravi','9890987656','Ravi@gmail.com','$2y$10$/muN/hB/MzABhW51ezS.3eXUZul.Eh0RzsPfdI6.hYbpo.K5SYvcm',5,NULL,'2023-08-05 04:50:06','2023-08-05 04:50:06',NULL);
...
insert  into `sms_manipulations`(`id`,`mobile_no`,`sms_type_id`,`sms_content`,`uid`,`status`,`created_at`,`updated_at`) values 
(NULL,'8838721805',1,'1396','f92f5618-85f3-4914-b730-07139d40bc70',NULL,'2023-07-13 09:25:57','2023-07-13 09:25:57'),
(NULL,'8838721805',1,'2390','f92f5618-85f3-4914-b730-07139d40bc70',NULL,'2023-07-24 05:25:59','2023-07-24 05:25:59'),
(NULL,'9865395029',1,'7225','8fa0e25b-e20b-46c1-8a5f-88fff244d20b',NULL,'2023-08-18 09:19:21','2023-08-18 09:19:21'),
(NULL,'9698591808',1,'4495','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 04:19:18','2023-08-21 04:19:18'),
(NULL,'9698591808',1,'7563','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 04:19:24','2023-08-21 04:19:24'),
(NULL,'9698591808',1,'5749','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 04:19:39','2023-08-21 04:19:39'),
(NULL,'9698591808',1,'4644','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 04:19:46','2023-08-21 04:19:46'),
(NULL,'9698591808',1,'2745','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 04:23:15','2023-08-21 04:23:15'),
(NULL,'9698591808',1,'2709','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 04:26:18','2023-08-21 04:26:18'),
(NULL,'9698591808',1,'2525','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 04:26:19','2023-08-21 04:26:19'),
(NULL,'9698591808',1,'2197','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 04:26:23','2023-08-21 04:26:23'),
(NULL,'9698591808',1,'6176','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 04:26:23','2023-08-21 04:26:23'),
(NULL,'9698591808',1,'9463','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 04:26:24','2023-08-21 04:26:24'),
(NULL,'9698591808',1,'5089','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 04:27:16','2023-08-21 04:27:16'),
(NULL,'9698591808',1,'7277','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 04:28:05','2023-08-21 04:28:05'),
(NULL,'9698591808',1,'1149','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 04:29:23','2023-08-21 04:29:23'),
(NULL,'9698591808',1,'6823','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 04:29:25','2023-08-21 04:29:25'),
(NULL,'9698591808',1,'1989','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 04:30:55','2023-08-21 04:30:55'),
(NULL,'9698591808',1,'8495','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 04:31:01','2023-08-21 04:31:01'),
(NULL,'9698591808',1,'3731','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 04:31:12','2023-08-21 04:31:12'),
(NULL,'9698591808',1,'7470','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 04:31:16','2023-08-21 04:31:16'),
(NULL,'9698591808',1,'8016','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 04:31:22','2023-08-21 04:31:22'),
(NULL,'9865395029',1,'5732','cbc70f8e-6e04-4a9e-b4cc-9d3b25deb714',NULL,'2023-08-21 05:04:40','2023-08-21 05:04:40'),
(NULL,'9865395029',1,'1934','cbc70f8e-6e04-4a9e-b4cc-9d3b25deb714',NULL,'2023-08-21 05:04:43','2023-08-21 05:04:43'),
(NULL,'9865395029',1,'2745','cbc70f8e-6e04-4a9e-b4cc-9d3b25deb714',NULL,'2023-08-21 09:21:48','2023-08-21 09:21:48'),
(NULL,'9865395029',1,'2179','cbc70f8e-6e04-4a9e-b4cc-9d3b25deb714',NULL,'2023-08-21 10:03:34','2023-08-21 10:03:34'),
(NULL,'9865395029',1,'5543','cbc70f8e-6e04-4a9e-b4cc-9d3b25deb714',NULL,'2023-08-21 10:03:37','2023-08-21 10:03:37'),
(NULL,'9698591808',1,'7659','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 10:04:13','2023-08-21 10:04:13'),
(NULL,'9698591808',1,'2235','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 10:04:15','2023-08-21 10:04:15'),
(NULL,'9698591808',1,'6257','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-21 10:04:30','2023-08-21 10:04:30'),
(NULL,'9865396190',1,'8127','5ff3f426-d212-4490-8efd-1abef9118ef9',NULL,'2023-08-21 10:09:23','2023-08-21 10:09:23'),
(NULL,'9865395029',1,'4442','cbc70f8e-6e04-4a9e-b4cc-9d3b25deb714',NULL,'2023-08-21 10:11:09','2023-08-21 10:11:09'),
(NULL,'9865395029',1,'9535','cbc70f8e-6e04-4a9e-b4cc-9d3b25deb714',NULL,'2023-08-21 10:39:55','2023-08-21 10:39:55'),
(NULL,'9865395029',1,'4662','cbc70f8e-6e04-4a9e-b4cc-9d3b25deb714',NULL,'2023-08-21 10:39:57','2023-08-21 10:39:57'),
(NULL,'9865395029',1,'8291','cbc70f8e-6e04-4a9e-b4cc-9d3b25deb714',NULL,'2023-08-21 10:40:02','2023-08-21 10:40:02'),
(NULL,'9865395029',1,'6411','cbc70f8e-6e04-4a9e-b4cc-9d3b25deb714',NULL,'2023-08-21 10:41:27','2023-08-21 10:41:27'),
(NULL,'9865396190',1,'6345','5ff3f426-d212-4490-8efd-1abef9118ef9',NULL,'2023-08-21 12:04:51','2023-08-21 12:04:51'),
(NULL,'9865396190',1,'4978','5ff3f426-d212-4490-8efd-1abef9118ef9',NULL,'2023-08-21 12:04:55','2023-08-21 12:04:55'),
(NULL,'9865396190',1,'8286','5ff3f426-d212-4490-8efd-1abef9118ef9',NULL,'2023-08-21 12:05:21','2023-08-21 12:05:21'),
(NULL,'9865396190',1,'5775','5ff3f426-d212-4490-8efd-1abef9118ef9',NULL,'2023-08-22 03:49:34','2023-08-22 03:49:34'),
(NULL,'9865396190',1,'8571','5ff3f426-d212-4490-8efd-1abef9118ef9',NULL,'2023-08-22 03:51:07','2023-08-22 03:51:07'),
(NULL,'9865396190',1,'5306','5ff3f426-d212-4490-8efd-1abef9118ef9',NULL,'2023-08-22 03:51:14','2023-08-22 03:51:14'),
(NULL,'9865396190',1,'1997','5ff3f426-d212-4490-8efd-1abef9118ef9',NULL,'2023-08-22 03:51:36','2023-08-22 03:51:36'),
(NULL,'9865396190',1,'9774','5ff3f426-d212-4490-8efd-1abef9118ef9',NULL,'2023-08-22 03:51:46','2023-08-22 03:51:46'),
(NULL,'9865396190',1,'4603','5ff3f426-d212-4490-8efd-1abef9118ef9',NULL,'2023-08-22 03:51:52','2023-08-22 03:51:52'),
(NULL,'9865396190',1,'4343','5ff3f426-d212-4490-8efd-1abef9118ef9',NULL,'2023-08-22 03:52:04','2023-08-22 03:52:04'),
(NULL,'9865396190',1,'8127','5ff3f426-d212-4490-8efd-1abef9118ef9',NULL,'2023-08-22 04:18:21','2023-08-22 04:18:21'),
(NULL,'9865396190',1,'1643','c4dfe62c-1564-4e61-862a-98b165d71d9a',NULL,'2023-08-22 04:45:07','2023-08-22 04:45:07'),
(NULL,'9865396190',1,'1630','c4dfe62c-1564-4e61-862a-98b165d71d9a',NULL,'2023-08-22 04:46:29','2023-08-22 04:46:29'),
(NULL,'9865396190',1,'7693','c4dfe62c-1564-4e61-862a-98b165d71d9a',NULL,'2023-08-22 04:46:35','2023-08-22 04:46:35'),
(NULL,'9865396190',1,'1306','c4dfe62c-1564-4e61-862a-98b165d71d9a',NULL,'2023-08-22 04:46:45','2023-08-22 04:46:45'),
(NULL,'9865396190',1,'5611','c4dfe62c-1564-4e61-862a-98b165d71d9a',NULL,'2023-08-22 05:52:24','2023-08-22 05:52:24'),
(NULL,'9865396190',1,'1547','c4dfe62c-1564-4e61-862a-98b165d71d9a',NULL,'2023-08-22 05:52:43','2023-08-22 05:52:43'),
(NULL,'8838721805',1,'8348','28c5621e-3d9c-45dc-b44c-9d473d2d1af0',NULL,'2023-08-22 09:56:54','2023-08-22 09:56:54'),
(NULL,'8838721805',1,'5130','28c5621e-3d9c-45dc-b44c-9d473d2d1af0',NULL,'2023-08-22 10:12:04','2023-08-22 10:12:04'),
(NULL,'8838721805',1,'2028','28c5621e-3d9c-45dc-b44c-9d473d2d1af0',NULL,'2023-08-22 10:15:25','2023-08-22 10:15:25'),
(NULL,'8838721805',1,'6787','28c5621e-3d9c-45dc-b44c-9d473d2d1af0',NULL,'2023-08-22 10:15:27','2023-08-22 10:15:27'),
(NULL,'8838721805',1,'3729','28c5621e-3d9c-45dc-b44c-9d473d2d1af0',NULL,'2023-08-22 10:15:27','2023-08-22 10:15:27'),
(NULL,'8838721805',1,'5904','28c5621e-3d9c-45dc-b44c-9d473d2d1af0',NULL,'2023-08-22 10:15:40','2023-08-22 10:15:40'),
(NULL,'8838721805',1,'6739','28c5621e-3d9c-45dc-b44c-9d473d2d1af0',NULL,'2023-08-22 10:15:42','2023-08-22 10:15:42'),
(NULL,'8838721805',1,'9478','28c5621e-3d9c-45dc-b44c-9d473d2d1af0',NULL,'2023-08-22 10:53:18','2023-08-22 10:53:18'),
(NULL,'8838721805',1,'5855','28c5621e-3d9c-45dc-b44c-9d473d2d1af0',NULL,'2023-08-22 10:54:00','2023-08-22 10:54:00'),
(NULL,'8838721805',1,'9071','28c5621e-3d9c-45dc-b44c-9d473d2d1af0',NULL,'2023-08-22 10:56:50','2023-08-22 10:56:50'),
(NULL,'8838721805',1,'8600','28c5621e-3d9c-45dc-b44c-9d473d2d1af0',NULL,'2023-08-22 10:56:52','2023-08-22 10:56:52'),
(NULL,'8838721805',1,'4073','28c5621e-3d9c-45dc-b44c-9d473d2d1af0',NULL,'2023-08-22 10:56:57','2023-08-22 10:56:57'),
(NULL,'9698591808',1,'6896','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-22 10:59:27','2023-08-22 10:59:27'),
(NULL,'9698591808',1,'7999','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-22 11:02:01','2023-08-22 11:02:01'),
(NULL,'9874563211',1,'3061','a068df2b-8d90-4097-8184-c9b4dc62e548',NULL,'2023-08-22 11:18:38','2023-08-22 11:18:38'),
(NULL,'8838721805',1,'9097','28c5621e-3d9c-45dc-b44c-9d473d2d1af0',NULL,'2023-08-24 04:35:17','2023-08-24 04:35:17'),
(NULL,'9698591808',1,'9495','9569cf1b-df49-4f01-a096-c344a354e952',NULL,'2023-08-24 04:36:42','2023-08-24 04:36:42'),
(NULL,'8838721805',1,'8522','28c5621e-3d9c-45dc-b44c-9d473d2d1af0',NULL,'2023-08-24 09:35:47','2023-08-24 09:35:47'),
(NULL,'9865396190',1,'6952','c4dfe62c-1564-4e61-862a-98b165d71d9a',NULL,'2023-08-25 08:54:30','2023-08-25 08:54:30');
...
insert  into `sms_types`(`id`,`name`,`status`,`created_by`,`updated_by`) values 
(1,'PersonToUser',1,NULL,NULL);
...
CREATE TABLE `temp_organizations` (
  ...
  `authority_status` int(11) NOT NULL DEFAULT 0,
  `tried_person_id` varchar(250) NOT NULL,
  `gst_available_status` int(11) NOT NULL DEFAULT 0,
...
insert  into `temp_organizations`(`id`,`org_name`,`org_email`,`org_website`,`door_no`,`building_name`,`street`,`landmark`,`pincode`,`district_id`,`state_id`,`city_id`,`area`,`location`,`authority_status`,`tried_person_id`,`gst_available_status`,`gst_no`,`pan_no`,`deleted_at`,`created_at`,`updated_at`) values 
(1,'PropelSoft','Soft@gmail.com','testing','F3','IT Park','TVS','BDU',622515,3,1,2,'Air Port','Trichy',0,'28c5621e-3d9c-45dc-b44c-9d473d2d1af0',0,123456,12345,NULL,'2023-09-01 10:40:40','2023-09-01 10:40:40');
...
insert  into `user_organization_relationals`(`id`,`uid`,`organization_id`,`default_org`,`created_at`,`updated_at`) values 
(13,'28c5621e-3d9c-45dc-b44c-9d473d2d1af0',1,NULL,'2023-08-31 11:18:01','2023-08-31 11:18:01'),
(14,'28c5621e-3d9c-45dc-b44c-9d473d2d1af0',2,NULL,'2023-08-31 11:27:48','2023-08-31 11:27:48');
...
(1,'28c5621e-3d9c-45dc-b44c-9d473d2d1af0','8838721805','harish@gmail.com','$2y$10$4ibQobVaTrSEE5oez5L3SeZDZ.BN9.ggXLstKvRaqROSgYt4wumiO',1,'2023-08-18 10:54:49','2023-08-25 06:26:20'),
(12,'c4dfe62c-1564-4e61-862a-98b165d71d9a','9865396190','dinesh@gmail.com','$2y$10$Mf5BQpRyW5gQ0.UZKs0AweUsENMjJgFDQRITYqDp.KtMcJcbZstzW',1,'2023-08-25 08:58:23','2023-08-25 08:58:51');
