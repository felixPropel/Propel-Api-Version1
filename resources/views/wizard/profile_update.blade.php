                ...
                <div class="card auth-card">
                    ...
                    <div class="form-side">
                        ...
                        <form action="{{route('complete_profile')}}" class="frm-single" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="row form-group header_profile_pic">
                                <div class="small-12 medium-2 large-2 columns">
                                    <div class="circle">
                                        ...
                                        @endif
                                       @if ($result[0]['profile_pic']!='')
                                       <img class="profile-pic" src="{{$result[0]['profile_pic']}}">    
                                       @endif
                                        <!-- Default Image -->
                            ...
                            <label class="form-group has-float-label mb-4">
                                <input class="form-control" type="text" placeholder="home address" name="home_address" value="{{ old('home_address') }}" />
                                <span class="text-danger">@error('home_address'){{ $message }}@enderror</span>
                                <span>Home Address</span>
                            </label>

                            <label class="form-group has-float-label mb-4">
                                <input class="form-control" type="text" placeholder="office address" name="office_address" value="{{ old('office_address') }}" />
                                <span class="text-danger">@error('office_address'){{ $message }}@enderror</span>
                                <span>Office Address</span>
                            </label>

                            <label class="form-group has-float-label mb-4">
                                <input class="form-control" type="text" placeholder="Family Name" name="family_name" value="{{$result[0]['first_name'].' '.'family'}}" />
