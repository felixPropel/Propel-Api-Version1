            ...
            <div class="col-12 col-md-10 mx-auto my-auto">
                <div class="card auth-card">
                    ...
                    <div class="form-side">
                        ...
                        <form action="{{route('set_pasword')}}" class="frm-single" method="post" autocomplete="off">
                            @csrf
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <button class="btn btn-primary btn-lg btn-shadow sign_up" type="submit">Submit</button>
                            </div>
                        </form>
