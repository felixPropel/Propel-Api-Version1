...
class OrganizationRepository implements OrganizationInterface
{
    ...
    {
        return UserOrganizationRelational::select('organizations.id as orgId', 'organization_details.org_name', 'user_organization_relationals.default_org', 'organizations.stage')
