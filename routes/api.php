...
Route::group(['middleware' => ['cors', 'json.response'], 'namespace' => 'App\Http\Controllers'], function () {
    ...
    Route::post('/person_details_update_extra', '@person_details_update_extra')->name('person_details_update_extra.api');
    Route::post('/store_mobile', 'Person\PersonController@store_mobile')->name('store_mobile.api');
    Route::post('/make_primary', 'Person\PersonController@make_primary')->name('make_primary.api');
    Route::post('/make_email_primary', 'Person\PersonController@make_email_primary')->name('make_email_primary.api');
    Route::post('/make_email_secondary', 'Person\PersonController@make_email_secondary')->name('make_email_secondary.api');
    Route::post('/make_email_primary_secondary', 'Person\PersonController@make_email_primary_secondary')->name('make_email_primary_secondary.api');
    Route::post('/delete_other', 'Person\PersonController@delete_other')->name('delete_other.api');
    Route::post('/delete_other_email', 'Person\PersonController@delete_other_email')->name('delete_other_email.api');
    //Person//
